...
function AdminDashboard({ onLogout }) {
  ...
  if (!token) return <div className="buk-card" style={{margin:'48px auto',maxWidth:400}}>Not logged in.</div>;
  ...
  return (
    <div className="admin-dashboard">
      ...
      <main className="admin-main">
        ...
        {loading ? <div>Loading...</div> : error ? <div className="buk-result error">{error}</div> : (
